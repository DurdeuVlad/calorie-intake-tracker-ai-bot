...
@Component public class TelegramHttpGateway implements TelegramGateway {
 ...
 public long sendMessage(long chatId,String text){return call("sendMessage",Map.of("chat_id",chatId,"text",TelegramPlainText.normalize(text)),true);}
 public void editMessage(long chatId,long messageId,String text){call("editMessageText",Map.of("chat_id",chatId,"message_id",messageId,"text",TelegramPlainText.normalize(text)),false);}

...
public record JournalIntent(IntentType type, String mealDescription, Integer calories, String query, Long entryId, String timezone, Integer calorieTarget, Boolean reportsEnabled, List<MealItem> items, Instant eatenAt, String nutritionSource, String confidence) {
 ...
 public record MealItem(String name, Double grams, Integer calories, Double proteinGrams, Double carbsGrams, Double fatGrams, String barcode) { public MealItem(String name,Double grams,Integer calories,Double proteinGrams,Double carbsGrams,Double fatGrams){this(name,grams,calories,proteinGrams,carbsGrams,fatGrams,null);} public MealItem(String name,Double grams,Integer calories){this(name,grams,calories,null,null,null,null);} }
}

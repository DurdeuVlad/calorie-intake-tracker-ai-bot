...
public class OutboundTelegramMessage {
  ...
  public OutboundTelegramMessage(long chatId,String text){this(chatId,text,null);}
  public OutboundTelegramMessage(long chatId,String text,Long sourceUpdateId){this.chatId=chatId;this.text=text;this.sourceUpdateId=sourceUpdateId;}
  public Long getId(){return id;} public long getChatId(){return chatId;} public Long getSourceUpdateId(){return sourceUpdateId;} public String getText(){return text;} public Status getStatus(){return status;} public UUID getLeaseToken(){return leaseToken;}

...
public class PendingNutritionQuote {
  ...
  private PendingNutritionQuote(FoodUser user, Type type, String name, String brand, double grams, int calories, String barcode, String sourceUrl, String basis, Instant now) {
    this.id=UUID.randomUUID(); this.user=user; this.type=type; this.productName=name; this.brand=brand;
  ...
  public static PendingNutritionQuote packaged(FoodUser user, String name, String brand, double grams, int calories, String barcode, String sourceUrl, Instant now) { return new PendingNutritionQuote(user,Type.PACKAGED_MATCH,name,brand,grams,calories,barcode,sourceUrl,null,now); }
  public static PendingNutritionQuote estimate(FoodUser user, String name, double grams, int calories, String basis, Instant now) { return new PendingNutritionQuote(user,Type.AI_ESTIMATE,name,null,grams,calories,null,null,basis,now); }
  public UUID getId(){return id;} public FoodUser getUser(){return user;} public Type getType(){return type;} public String getProductName(){return productName;} public String getBrand(){return brand;} public double getGrams(){return grams.doubleValue();} public int getCaloriesPer100g(){return caloriesPer100g;} public String getBarcode(){return barcode;} public String getSourceUrl(){return sourceUrl;} public String getEstimateBasis(){return estimateBasis;} public Instant getCreatedAt(){return createdAt;} public Instant getExpiresAt(){return expiresAt;}
}

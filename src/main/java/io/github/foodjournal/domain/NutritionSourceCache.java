...
@Entity @Table(name="nutrition_source_cache") public class NutritionSourceCache {
 ...
 @Column(nullable=false,unique=true) private String barcode; @Column(nullable=false) private String productName; @Column(name="calories_per_100g") private Integer caloriesPer100g; @Column(name="protein_per_100g") private BigDecimal proteinPer100g; @Column(name="carbs_per_100g") private BigDecimal carbsPer100g; @Column(name="fat_per_100g") private BigDecimal fatPer100g; @Column(nullable=false,columnDefinition="text") private String sourceUrl; @Column(nullable=false) private Instant fetchedAt;
